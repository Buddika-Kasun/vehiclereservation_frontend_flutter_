...
import 'package:vehiclereservation_frontend_flutter_/features/users/admin/vehicle_management/checklist/widgets/checklist_card.dart';
import 'package:vehiclereservation_frontend_flutter_/shared/widgets/count_badge.dart';
import 'package:intl/intl.dart';

class ReviewChecklistsScreen extends StatefulWidget {
  final UserRole userRole;

  const ReviewChecklistsScreen({Key? key, required this.userRole})
    : super(key: key);

  @override
  _ReviewChecklistsScreenState createState() => _ReviewChecklistsScreenState();
}

class _ReviewChecklistsScreenState extends State<ReviewChecklistsScreen> {
  // Common properties
  ...
  Future<void> fetchChecklists({required bool reset}) async {
    try {
      ...
      final response = await ApiService.getChecklists(request);
  ...
  void _navigateToChecklistDetails(ChecklistResponse checklist) async {
          ...
          Column(
            children: [
              TripHeader(
                ...
                subtitle: 'Review checklists and approve them',
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    CountBadge(totalCount: total, label: "Checklists"),
                    const Spacer(),
