...
class _AllTripsScreenState extends BaseTripListState<AllTripsScreen> {
  @override
  String getScreenTitle() => 'All Trips';

  @override
  String getScreenSubtitle() => 'Browse all available trips and add or join';
