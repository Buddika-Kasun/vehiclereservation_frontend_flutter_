...
class HrDashboardContent extends StatelessWidget {
  ...
  const HrDashboardContent({Key? key, required this.user}) : super(key: key);
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 12),
                Text(
                  'You have 5 trip requests waiting for approval',
          ...
          Row(
            children: [
              _buildApprovalStat('Today', '3', Colors.blue),
              SizedBox(width: 12),
              _buildApprovalStat('This Week', '15', Colors.green),
              SizedBox(width: 12),
              _buildApprovalStat('Pending', '5', Colors.orange),
              SizedBox(width: 12),
              _buildApprovalStat('Rejected', '2', Colors.red),
            ],
          ),
